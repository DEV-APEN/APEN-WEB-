...
/** Rutas reales del sitio: da a personas y agentes una salida desde el 404. */
const ROUTE_MAP = [
  { href: '/', label: 'Inicio' },
  { href: '/servicios', label: 'Servicios' },
  { href: '/servicios/energia', label: 'Sector eléctrico' },
  { href: '/servicios/hidrocarburos', label: 'Hidrocarburos' },
  { href: '/servicios/financiamiento-de-proyectos', label: 'Financiamiento de proyectos' },
  { href: '/servicios/legal', label: 'Defensa legal' },
  { href: '/nosotros', label: 'Nosotros' },
  { href: '/servicios/energia#ingenieria-y-ejecucion', label: 'Ingeniería y ejecución' },
  { href: '/certificaciones', label: 'Certificaciones' },
  { href: '/consultas', label: 'Energy Explica' },
      ...
      <section className="flex-grow flex items-center justify-center relative z-10 px-6 pt-36 pb-20">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            ...
            {/* MAPA DE RUTAS — recuperación para personas y agentes de IA */}
            <nav
              aria-label="Rutas disponibles"
              className="max-w-3xl mx-auto mt-16 pt-10 border-t border-[#008CDE]/15"
            >
              <p className="text-[10px] font-black text-slate-500 uppercase tracking-[0.4em] mb-6">
                Rutas disponibles
              </p>
              ...
              <ul className="flex flex-wrap items-center justify-center gap-x-6 gap-y-3">
                {ROUTE_MAP.map((route) => (
                  <li key={route.href}>
                    <Link
                      href={route.href}
                      className="text-xs font-bold text-slate-400 hover:text-[#008CDE] uppercase tracking-[0.15em] transition-colors duration-300"
                    >
                      {route.label}
                    </Link>
                  </li>
              ...
              <p className="mt-8 text-[11px] text-slate-600 leading-relaxed">
                ...
                <a href="/sitemap.xml" className="text-slate-500 hover:text-[#008CDE] transition-colors">
                  /sitemap.xml
                </a>{' '}
                ·{' '}
                <a href="/llms.txt" className="text-slate-500 hover:text-[#008CDE] transition-colors">
                  /llms.txt
                </a>{' '}
                ·{' '}
                <a
                  href="/agent-instructions.md"
                  className="text-slate-500 hover:text-[#008CDE] transition-colors"
                >
