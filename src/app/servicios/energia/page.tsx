...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'consultoría sector eléctrico',
    'supervisión de obra eléctrica',
    'servicios eléctricos industriales',
    'gestión de proyectos eléctricos industriales México',
    'ingeniería eléctrica proyectos energéticos',
  ],
  alternates: {
