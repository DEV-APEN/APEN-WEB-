...
const organizationJsonLd = {
  ...
  address: [
    ...
    },
    {
      ...
      streetAddress: 'Av. Coyoacán 644, Del Valle Centro',
  ...
  return (
    <html lang="es" className="scroll-smooth">
      <head>
        <Script id="google-tag-manager" strategy="afterInteractive">
          {`
            ...
            })(window,document,'script','dataLayer','GTM-TFXZQPB5');
          `}
        </Script>
      </head>
      <body className={`${inter.className} overflow-x-hidden w-full`}>
        <noscript>
          <iframe 
            src="https://www.googletagmanager.com/ns.html?id=GTM-TFXZQPB5"
            height="0" 
            width="0" 
